...
public class LocationService extends Service {
    public static final String CHANNEL_ID = "ForegroundLocationService";
    ...
    public void onCreate() {
        super.onCreate();
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "fafa").setContentTitle("Notifications Example")
